...
class StanleyController:
    ...
    # vvv below is untested vvv

    # def compute_cte(self, SEVpos, wp1, wp2):
    ...
    # def heading_error(self, SEV_heading, wp1, wp2):

    #     path_dir = (wp2 - wp1).normalize()
    ...
    #     steer = theta_err + math.degrees(math.atan(self.k_gain * cte / v))
